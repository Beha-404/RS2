...
class AddFormPanel extends StatefulWidget {
  ...
  @override
  State<AddFormPanel> createState() => _AddFormPanelState();
}

class _AddFormPanelState extends State<AddFormPanel> {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Add new ${widget.componentType.toUpperCase()}',
