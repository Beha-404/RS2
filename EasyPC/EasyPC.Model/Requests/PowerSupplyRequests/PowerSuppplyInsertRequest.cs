...
namespace EasyPC.Model.Requests.PowerSupplyRequests
{
    ...
    {
        [Required(ErrorMessage = "Naziv napajanja je obavezan")]
        ...
        [Required(ErrorMessage = "Snaga napajanja je obavezna")]
        [MinLength(2, ErrorMessage = "Snaga mora imati najmanje 2 karaktera")]
        [MaxLength(50, ErrorMessage = "Snaga ne može imati više od 50 karaktera")]
